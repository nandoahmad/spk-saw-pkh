...
CREATE TABLE IF NOT EXISTS `kriteria` (
  `kd_jenis_bantuan` int(11) NOT NULL AUTO_INCREMENT,
  `kd_beasiswa` int(11) NOT NULL,
  `nama` varchar(50) DEFAULT NULL,
  `sifat` enum('min','max') DEFAULT NULL,
  PRIMARY KEY (`kd_jenis_bantuan`),
...
INSERT INTO `kriteria` (`kd_jenis_bantuan`, `kd_beasiswa`, `nama`, `sifat`) VALUES
(1, 1, 'IPK', 'max'),
(2, 1, 'Semester', 'max'),
...
CREATE TABLE IF NOT EXISTS `model` (
  ...
  KEY `fk_kriteria` (`kd_jenis_bantuan`),
  KEY `fk_beasiswa` (`kd_beasiswa`)
...
INSERT INTO `model` (`kd_model`, `kd_beasiswa`, `kd_jenis_bantuan`, `bobot`) VALUES
(1, 1, 1, '0.50'),
(2, 1, 2, '0.20'),
(3, 1, 3, '0.30'),
(4, 2, 4, '0.40'),
...
INSERT INTO `nilai` (`kd_nilai`, `kd_beasiswa`, `kd_jenis_bantuan`, `nim`, `nilai`) VALUES
(1, 1, 1, '125610036', 2),
(2, 1, 2, '125610036', 3),
(3, 1, 3, '125610036', 2),
(4, 1, 1, '125610080', 1),
...
INSERT INTO `penilaian` (`kd_penilaian`, `kd_beasiswa`, `kd_jenis_bantuan`, `keterangan`, `bobot`) VALUES
(1, 1, 1, '3.00 - 3.20', 1),
(2, 1, 1, '3.21 - 3.40', 2),
(3, 1, 1, '3.41 - 3.40', 3),
(4, 1, 1, '>= 3.61', 4),
