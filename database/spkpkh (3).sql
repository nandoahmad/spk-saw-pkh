...
--
-- Host: 127.0.0.1
-- Generation Time: 20 Jul 2021 pada 07.52
...
(94, 'q', 'c4ca4238a0b923820dcc509a6f75849b', 'warga');
...
(31, 8978707015, 'suwaji', 7, 'suwaji', 'sidorejo', '1992-01-31', 'Laki-laki', 'tidak hamil', 'tidak ada', 'tidak ada', 'ada', 'ada', '>60', '', '2021'),
(32, 7807897789079, 'mardiyah', 7, 'Mardiyah', 'sidorejo', '1987-10-07', 'Perempuan', 'tidak hamil', 'tidak ada', 'ada', 'tidak ada', 'ada', '>60', 'fisik', '2021'),
(33, 52364757475775, 'sumarni', 7, 'Sumarni', 'sidorejo', '2002-06-07', 'Perempuan', 'hamil', 'tidak ada', 'tidak ada', 'ada', 'ada', '>60', '', '2021'),
(34, 871785656709565, 'ngatemi', 7, 'Ngatemi', 'sidorejo', '2003-06-07', 'Perempuan', 'tidak hamil', 'tidak ada', 'ada', 'ada', 'ada', '>60', '', '2021'),
...
(47, 5235, 'rizal', 7, 'panjol', 'Lumajang', '1989-01-02', 'Laki-laki', 'tidak hamil', 'tidak ada', 'ada', 'ada', 'ada', '>60', '', '2021'),
(49, 12345, 'w', 7, 'williab', 'bromo', '1922-01-02', 'Laki-laki', 'tidak hamil', 'tidak ada', 'tidak ada', 'ada', 'ada', '>60', 'tidak disabilitas', '2021'),
(50, 12345, 'q', 7, 'qqq', 'mastrip', '1998-02-03', 'Perempuan', 'hamil', 'tidak ada', 'tidak ada', 'ada', 'ada', '>60', 'tidak disabilitas', '2021');
...
--
ALTER TABLE `hasil`
  MODIFY `kd_hasil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=225;
--
...
--
ALTER TABLE `model`
  MODIFY `kd_model` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT for table `nilai`
--
ALTER TABLE `nilai`
  MODIFY `kd_nilai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=278;
--
-- AUTO_INCREMENT for table `pengguna`
--
ALTER TABLE `pengguna`
  MODIFY `kd_pengguna` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
--
