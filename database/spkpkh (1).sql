...
--
-- Host: 127.0.0.1
-- Generation Time: 19 Jul 2021 pada 17.18
...
(161, 7, 17, 'Menyusui', 1),
(162, 7, 17, 'Hamil', 0.5),
(163, 7, 17, 'Tidak Ada', 0.25),
(164, 7, 18, 'Ada', 1),
(170, 7, 18, 'Tidak Ada', 0.5),
(171, 7, 19, 'Ada', 1),
(172, 7, 19, 'Tidak Ada', 0.5),
(173, 7, 20, 'Ada', 1),
(174, 7, 20, 'Tidak Ada', 0.5),
(175, 7, 21, 'Ada', 1),
(176, 7, 21, 'Tidak Ada', 0.5),
(177, 7, 22, '<60 Tahun', 0.5),
(178, 7, 22, '>60 Tahun', 1),
(179, 7, 23, 'Fisik', 1),
(180, 7, 23, 'Intelektual', 0.75),
(182, 7, 23, 'Mental', 0.5),
(183, 7, 23, 'Tidak Ada', 0.25),
(184, 7, 24, 'Tidak Layak', 1),
(185, 7, 24, 'Cukup', 0.5),
(186, 7, 24, 'Layak', 0.25);
...
--
ALTER TABLE `hasil`
  MODIFY `kd_hasil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=219;
--
...
--
ALTER TABLE `model`
  MODIFY `kd_model` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
-- AUTO_INCREMENT for table `nilai`
--
ALTER TABLE `nilai`
  MODIFY `kd_nilai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=518;
--
-- AUTO_INCREMENT for table `pengguna`
--
ALTER TABLE `pengguna`
  MODIFY `kd_pengguna` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;
--
-- AUTO_INCREMENT for table `penilaian`
--
ALTER TABLE `penilaian`
  MODIFY `kd_penilaian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;
--
-- AUTO_INCREMENT for table `warga`
--
ALTER TABLE `warga`
  MODIFY `nomor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
