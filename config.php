 ...
 */
 if (!$connection = new Mysqli("localhost", "root", "", "spkpkh")) {
...
//  */
 if (isset($_GET["page"])) {
   $_PAGE = $_GET["page"];
 // } else if (!isset($_GET["page"]) && $_SESSION['status'] == 'calonwarga') {
 //   $_PAGE = "home_cwarga";
 } else{
   $_PAGE = "home";
 }
...
// mysql_connect("localhost","root","","spkpkh");
$konek = mysqli_connect("localhost", "root", "", "spkpkh");
